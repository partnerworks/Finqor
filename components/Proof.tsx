  ...
  return (
    <section id="proof" className="py-20 bg-primary text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-0">
          <div className="grid grid-cols-2 lg:grid-cols-5 divide-y lg:divide-y-0 divide-slate-100">
            <Metric label="Retention" value="100%" subtext="Client Success Rate" />
            <Metric label="Efficiency" value="40-72%" subtext="Cost Saving Efficiency" />
            <Metric label="Capacity" value="10 Billion +" subtext="Quarterly Transactions" />
